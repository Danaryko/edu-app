            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-3 text-right">
                        <a href="/login" class="small mr-3 {{ Request::is('/login') ? 'menu-active' : '' }}"><span class="icon-unlock-alt"></span> Log In</a>
                        <a href="/register" class="small btn btn-primary px-4 py-2 rounded-0 {{ Request::is('/register') ? 'menu-active' : '' }}"><span
